      ...
      <div class="answer">
        <div v-show="selectedType === 'question'">
          ...
          <div class="card-container" v-if="showForm">
            <div class="card">
              <QuestionSubmitInfoCard :questionSubmitResult="questionSubmitResult" :title="selectedTree.title" @closeEvent="handleCloseEvent"/>
            </div>
          </div>
...
import {
  ...
  QuestionSubmitAddTestRequest, QuestionSubmitVO, QuestionWrongControllerService,
